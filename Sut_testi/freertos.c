...
void StartTelemetriTask(void const * argument)
{
  ...
  for(;;)
  {
      ...
      insert_float_to_packet(x_ekseni, telemetri_paketi, 9);
      insert_float_to_packet(y_ekseni, telemetri_paketi, 13);
      insert_float_to_packet(z_ekseni, telemetri_paketi, 17);
